...
class TopStories extends StatefulWidget {
  ...
  @override
  State<TopStories> createState() => _TopStories();
}

class _TopStories extends State<TopStories> {
  ...
  Future<List<NewsDetails>> fetchNewsDetails() async {
    final ids = await HackerNewsApi.fetchStoryIds('top');
    final details = await Future.wait(ids.take(20).map
    (HackerNewsApi.fetchNewsDetails));
    return details;
  }
